...
#ifndef CUSTOM_MSGS__MSG__DETAIL__CUSTOM_MESSAGE__FUNCTIONS_H_
#define CUSTOM_MSGS__MSG__DETAIL__CUSTOM_MESSAGE__FUNCTIONS_H_
 ...
 * calls
 * custom_msgs__msg__CustomMessage__init().
...
/**
 * It calls
 * custom_msgs__msg__CustomMessage__fini()
 ...
 * custom_msgs__msg__CustomMessage__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * custom_msgs__msg__CustomMessage__Sequence__fini()
 * on the array,
...
#endif  // CUSTOM_MSGS__MSG__DETAIL__CUSTOM_MESSAGE__FUNCTIONS_H_
